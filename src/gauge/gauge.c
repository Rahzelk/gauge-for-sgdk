...
/**
 * Initialize the fill tilemap once for one lane.
 *
 * Allocates one VRAM tile per valid cell, writes the tilemap on the configured
 * plane, and leaves tile data uploads to the runtime update path.
 */
